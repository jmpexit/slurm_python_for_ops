...
def get_access_details_from_input():
    ...
    try:
        ...
        raise RuntimeError('Wrong values') from ValueError
      #  return None, None # TODO убрать raise, раскомментить return - отработает условие if access_from is None and access_period is None
    finally:
...
#TODO:  в дебаггере поймать место ошибки, пройтись по дереву,
#TODO:  выбрать Evaluate, ввести фрагмент проблемного кода и попробовать try - except
