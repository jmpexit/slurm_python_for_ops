# Вывести строку с интерполированными переменными +
# Убрать пробелы в начале и в конце имени +
# Убрать символы “~” в начале и конце имени +
# Сделать первую букву имени заглавной +
# Привести профессию к нижнему регистру +
# Заменить в адресе электронной почты символ “@ на предлог “at” +
# Разгадать и вывести секретный символ
...
# привести к виду Минимальной единицей Kubernetes является pod
platform = "K8s"
atomic_unit = "POD"
...
# При помощи срезов необходимо извлечь из строки следующие подстроки: "recovery", "recovery plan", "Disaster"
