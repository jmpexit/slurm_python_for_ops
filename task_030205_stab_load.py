#  понять, была ли нагрузка стабильной, или это были всплески и резкие снижения
#  посчитать среднее и медианное значение.
# Если среднее сильно ниже медианы - были снижения. Если сильно выше - были скачки. Критерием "сильного различия"
# можно считать отличие среднего от медианы более, чем на 30%.
# Медиана - это значение по обе стороны от которого находится одинаковое количество элементов.
# Для расчета медианы требуется отсортированная последовательность
